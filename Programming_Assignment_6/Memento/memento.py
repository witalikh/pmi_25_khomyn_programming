import os
from common import pickle_manager as pickle_func
...
class Memento:
    ...
    def __init__(self, name, state, obj):
        ...
        """
        self.state = state
        self.filename = fr'snapshots\{name}_{state}.pickle'
...
class Originator:
    ...
    def __init__(self, name, obj, type_cast):
        """
    ...
    def get_memento(self):
        ...
        """
        memento = Memento(self._name, self._state, self._iterable)
        self._state += 1
        return memento
...
class CareTaker:
    ...
    def __init__(self, name: str, obj, type_cast):
        """
        ...
        """
        self._originator = Originator(name, obj, type_cast)
    ...
    def accept_change(self):
        ...
        if self.max_undo_actions is not None and \
           len(self._undo_mementos) == self.max_undo_actions + 1:
...
__all__ = ["CareTaker", "NothingToUndo", "NothingToRedo"]
