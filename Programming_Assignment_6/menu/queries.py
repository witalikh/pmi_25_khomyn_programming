...
"""
from CovidCertificate import CovidCertificate, Container, MultipleCertErrors
from Memento import CareTaker, NothingToUndo, NothingToRedo

from common import JSONManager, Validate
...
class CertificatesQueriesThread:
    ...
    def __init__(self, database, messages: InterfaceMessages):
        ...
        self.caretaker = CareTaker("main_database", self.container, CovidCertificate)
