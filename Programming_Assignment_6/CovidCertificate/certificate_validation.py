...
"""
from common import Validate, get_today_date
...
class MultipleCertErrors(Exception):
    ...
    def __contains__(self, item):
        return item in map(type, self.container)
...
def __validate_dependent(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        prerequisites = {
            "min_passport": today.add(years=-Globals.min_passport_age),
            "max_passport": today.add(years=-Globals.max_passport_age),
