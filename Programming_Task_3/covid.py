...
class CovidCertificate:
    ...
    def __init__(self,
        ...
        CertificateValidation.validate_fields(identifier, username, international_passport,
...
class Container:
    ...
    def edit_record(self, identifier, key, value):
        ...
        try:
            ...
            # validate new value
            CertificateValidation.validate_fields(**kwargs)

            elem.__dict__[key] = value

        except KeyError:
            raise CertError.AbsentRecord
