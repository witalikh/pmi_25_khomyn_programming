...
from covid_validate import CertError, CertificateException
    ...
    def input_certificate(self):
        ...
        while True:
            try:
                ...
                identifier = input(self.messages.identifier_input)

                user_name = input(self.messages.name_input)
                international_passport = input(self.messages.passport_input)

                birth_date = input(self.messages.birth_date_input)
                start_date = input(self.messages.start_date_input)
                end_date = input(self.messages.end_date_input)

                vaccine = input(self.messages.vaccine_input)

                result = CovidCertificate(identifier,
                                          user_name, international_passport,
